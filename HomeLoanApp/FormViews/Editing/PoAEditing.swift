...
struct PoAEditing: View {
    ...
    init(application: Application, isDone: Binding<Bool>, sender: Sender) {
        ...
        self._poAName = State(wrappedValue: application.poAName ?? "")
        self._poAIdentityNumber = State(wrappedValue: application.poAIdentityNumber ?? "")
        self._poALocation = State(wrappedValue: application.poALocation ?? "")
        self._poAContact = State(wrappedValue: application.poAContact ?? "")
    }
